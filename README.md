...
### Common Problem: Brittle selectors break tests
...
- **Better coverage**: both normal (`regularHeal`) and self-healing (`autoHeal`) paths are protected.
